...
function SingleChallenge({hackathon}) {
  ...
  return (
    <div key={hackathon._id} className="bg-white text-black w-80 rounded-lg pb-4 m-5 flex flex-col items-center md:m-10 lg:m-24">
        ...
        <Link to={`hackathon/${hackathon._id}`}><h3 className='text-2xl font-bold my-1'>{hackathon.name}</h3></Link>
        ...
        <div className='mx-2'>
            ...
            <div className='flex justify-center'>
                <p className='mx-2 font-bold text-lg'>{('0'+timeLeft.days).slice(-2)}</p>
                <p className='mx-2 font-bold text-lg'>:</p>
                <p className='mx-2 font-bold text-lg'>{('0'+timeLeft.hours).slice(-2)}</p>
                <p className='mx-2 font-bold text-lg'>:</p>
                <p className='mx-2 font-bold text-lg'>{('0'+timeLeft.mins).slice(-2)}</p>
                {/* <p className='mx-2 font-bold text-lg'>:</p>
